import { getUser, getUserAddress, updateUser } from "./mock/users";
import { getExternalEmployees } from "./mock/integration";
import { ExternalEmployee, User, ExternalEmployeeAddress, UserAddress } from './types';
...
function convertExternalAddressToUserAddress(address: ExternalEmployeeAddress): unknown {
  return {
